...
async function get_UserDetail() {
    try {
      ...
      const apiResponse = await fetch("http://localhost:3333/mobile/Get-User_Detail", {
        method: "POST",
        body: bodyContent,
        headers: headersList,
      });
...
async function get_Payroll_Permission(ppr) {
    ...
    try {
      ...
      const apiResponse = await fetch("http://localhost:3333/mobile/Get-Payroll_Permission", {
        method: "POST",
        body: bodyContent,
        headers: headersList,
      });
...
async function get_roles() {
    try {
      ...
      const apiResponse = await fetch("http://localhost:3333/mobile/Get-Roles", {
        method: "POST",
        body: bodyContent,
        headers: headersList,
      });
...
async function get_permission(r_id) {
    try {
      ...
      const apiResponse = await fetch("http://localhost:3333/mobile/Get-Permission", {
        method: "POST",
        body: bodyContent,
        headers: headersList,
      });
        ...
        data_user.forEach((item) => {
            ...
            item.status === true ? text_state = '<span class="state_active_content">ใช้งาน</span>' : text_state = '<span class="state_inactive_content">ไม่ใช้งาน</span>';
             ...
             <tr  id='td_mouseenter'>
                ...
                <td><span class="material-symbols-outlined" id="master_data_icon_more">more_vert</span></td>
             </tr>
...
async function add_roles() {
    ...
    try {
        ...
        let response = await fetch(
            "http://localhost:3333/mobile/Add-Role",
            {
                method: "POST",
                body: bodyContent,
                headers: headersList,
...
async function edit_role() {
    ...
    try {
        ...
        let response = await fetch(
            "http://localhost:3333/mobile/Edit-Role_use",
            {
                method: "POST",
                body: bodyContent,
                headers: headersList,
...
async function update_payroll() {
    ...
    try {
        ...
        let response = await fetch(
            "http://localhost:3333/mobile/Update-RoleForPayroll",
            {
                method: "POST",
                body: bodyContent,
                headers: headersList,
...
async function add_payroll() {
    try {
        ...
        let response = await fetch(
            "http://localhost:3333/mobile/Add-RoleForPayroll",
            {
                method: "POST",
                body: bodyContent,
                headers: headersList,
...
async function update_permissions(data_for_update_permission) {
    try {
        ...
        let response = await fetch(
            "http://localhost:3333/mobile/Update-Permissions",
            {
                method: "POST",
                body: bodyContent,
                headers: headersList,
