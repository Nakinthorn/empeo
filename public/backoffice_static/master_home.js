...
async function getAPI_listmenu() {
        ...
        try {
          ...
          let response = await fetch(
            ENDPOINT + "mobile/Get-Master-List",
            {
              method: "POST",
              body: bodyContent,
              headers: headersList,
...
async function getAPI_master_bank() {
    try {
        ...
        let response = await fetch(
            ENDPOINT + "mobile/Get-Master-Bank",
            {
                method: "POST",
                body: bodyContent,
                headers: headersList,
...
async function getAPI_master_creer() {
    try {
        ...
        let response = await fetch(
            ENDPOINT + "mobile/Get-Master-Career",
            {
                method: "POST",
                body: bodyContent,
                headers: headersList,
...
async function getAPI_master_reasonforleaving() {
    try {
        ...
        let response = await fetch(
            ENDPOINT + "mobile/Get-Master-Reasonforleaving",
            {
                method: "POST",
                body: bodyContent,
                headers: headersList,
...
async function getAPI_master_attachment() {
    try {
        ...
        let response = await fetch(
            ENDPOINT + "mobile/Get-Master-Attachment",
            {
                method: "POST",
                body: bodyContent,
                headers: headersList,
...
async function getAPI_master_employee_type() {
    try {
        ...
        let response = await fetch(
            ENDPOINT + "mobile/Get-Master-Employee_type",
            {
                method: "POST",
                body: bodyContent,
                headers: headersList,
...
async function getAPI_master_companyreg() {
    try {
        ...
        let response = await fetch(
            ENDPOINT + "mobile/Get-Master-Companyreg",
            {
                method: "POST",
                body: bodyContent,
                headers: headersList,
...
async function getAPI_master_coursecategory() {
    try {
        ...
        let response = await fetch(
            ENDPOINT + "mobile/Get-Master-Coursecategory",
            {
                method: "POST",
                body: bodyContent,
                headers: headersList,
...
async function getAPI_master_skilltype() {
    try {
        ...
        let response = await fetch(
            ENDPOINT + "mobile/Get-Master-Skilltype",
            {
                method: "POST",
                body: bodyContent,
                headers: headersList,
...
async function getAPI_master_skillset() {
    try {
        ...
        let response = await fetch(
            ENDPOINT + "mobile/Get-Master-Skillset",
            {
                method: "POST",
                body: bodyContent,
                headers: headersList,
...
async function getAPI_master_reasonforseparation() {
    try {
        ...
        let response = await fetch(
            ENDPOINT + "mobile/Get-Master-Reasonforseparation",
            {
                method: "POST",
                body: bodyContent,
                headers: headersList,
...
async function postAPI_master_data(itemobj) {
    ...
    try {
        ...
        let response = await fetch(
            ENDPOINT + "mobile/Add-Master_Data",
            {
                method: "POST",
                body: bodyContent,
                headers: headersList,
...
async function postAPI_master_Edit_data(itemobj) {
    ...
    try {
        ...
        let response = await fetch(
            ENDPOINT + "mobile/Update-Master_Data",
            {
                method: "POST",
                body: bodyContent,
                headers: headersList,
...
async function postAPI_master_Delete_data(itemobj) {
    ...
    try {
        ...
        let response = await fetch(
            ENDPOINT + "mobile/Delete-Master_Data",
            {
                method: "POST",
                body: bodyContent,
                headers: headersList,
