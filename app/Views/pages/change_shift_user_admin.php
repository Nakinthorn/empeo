...
<body>
    ...
    <div id="c_forhide">
        <div class="container-shift-btn" onclick="cancel_request()">
    ...
    <div class="modal hide" id='modal_success' style='display:flex;'>
        <div class="modal_content">
            ...
            <div class="modal_footer">
                ...
                <button class="modal_btn_shift success_btn" onclick='confrim_request()'>Confirm</button>
            </div>
        </div>
    </div>
</body>
...
<script>
    ...
    let ID_LIST_APPROVE = <?php echo $id ?>;
    ...
    async function confrim_request() {
        try {
            let headersList = {
                "Accept": "*/*",
                "Content-Type": "application/json"
            ...
            let bodyContent = JSON.stringify({
                "token": "<?php echo  $_SESSION['token'];?>",
                "id_list_approve": parseInt(ID_LIST_APPROVE),
                'type': 'confirm',
                'sub_type' : 'shift'
            });

            let response = await fetch(ENDPOINT + "mobile/approve/request", {
                method: "POST",
                body: bodyContent,
                headers: headersList
            });
            ...
            let msg = data.msg
            if (msg === "success") {
                window.location.href = '/manager_document'
