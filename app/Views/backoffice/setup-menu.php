...
<style>
    .settings-container {
        margin-left: 5vw;
        padding: 23px;
        border-right: var(--border_dotDark_4);
        width: 250px;
        position: fixed;
    }
    ...
    .basic-info {
        ...
        border-radius: 15px;
        display: flex;
        box-shadow: var(--box_shadow_sos);
        cursor: pointer;
        margin-top: 10px;
        padding: 5%;
        transition: 0.5s;
        border: 1.5px solid #ef6d35;
    }
...
<div class="settings-container">
    ...
    <div id="basicinfo" onclick="setup_menu('basicinfo')" class="basic-info">
        <div style="width: 25%;">
            ...
            <div style="width: 100%;">
                <div style="display: flex; align-items: center;">
                    <div style="width: 100%; height: 9px; border-radius: 100px; position: relative; background-color: #e0e0e0;">
                        <div style="width: 30%; height: 9px; border-radius: 100px; position: absolute; top: 0; background-color: #ef6d35;">
                        </div>
                    </div>
    ...
    <div id="timeattendance" onclick="setup_menu('timeattendance')" class="time-attendance">
        <div style="width: 25%;">
        ...
        <div class="select-box">
            ...
            <div style="width: 100%;">
                <div style="display: flex; align-items: center;">
                    <div style="width: 100%; height: 9px; border-radius: 100px; position: relative; background-color: #e0e0e0;">
                        <div style="width: 30%; height: 9px; border-radius: 100px; position: absolute; top: 0; background-color: #5797fb;">
                        </div>
                    </div>
                    <p style="margin-left: 10px; font-size: 1vw; font-weight: 300; margin-top: -2px;">30%</p>
                </div>
    ...
    <div id="salary" onclick="setup_menu('salary')" class="salary">
        <div style="width: 25%;">
        ...
        <div class="select-box">
            ...
            <div style="width: 100%;">
                <div style="display: flex; align-items: center;">
                    <div style="width: 100%; height: 9px; border-radius: 100px; position: relative; background-color: #e0e0e0;">
                        <div style="width: 30%; height: 9px; border-radius: 100px; position: absolute; top: 0; background-color: #45c9aa;">
                        </div>
                    </div>
                    <p style="margin-left: 10px; font-size: 1vw; font-weight: 300; margin-top: -2px;">30%</p>
                </div>
    ...
    <div onclick="setup_menu('usermanage')" class="user-manage">
        <span style="margin-left: 10px;">ผู้ใช้</span>
    </div>

    <div onclick="location.href='master'" class="user-manage">
...
<script>
    $(document).ready(function() {
        ...
        var checksidebar = localStorage.getItem('setbar');
        var check_flag = localStorage.getItem('check_flag');
        console.log('checksidebar', checksidebar)
        if (checksidebar && checksidebar != null && checksidebar != undefined && check_flag && check_flag == 'true') {
    ...
    function setup_menu(id) {
        ...
        $('#timeattendance').css('border', '1.5px solid transparent')
        $('#salary').css('border', '1.5px solid transparent')
        console.log('idididididid', check_flag)
        var check_flag = localStorage.getItem('check_flag');
        ...
        if (check_flag == 'true') {
            if (id == 'basicinfo') {
                $('#basic_info').css('display', 'block')
                $('#basicinfo').css('border', '1.5px solid #ef6d35')
                localStorage.setItem('setbar', 'basicinfo')
                localStorage.setItem('check_flag', 'true')
                ...
                $('#time_attendance').css('display', 'block')
                $('#timeattendance').css('border', '1.5px solid #5797fb')
                localStorage.setItem('setbar', 'timeattendance')
                localStorage.setItem('check_flag', 'true')
                location.href = 'setup.html'
                ...
                $('#salary_info').css('display', 'block')
                $('#salary').css('border', '1.5px solid #45c9aa')
                localStorage.setItem('setbar', 'salary')
                localStorage.setItem('check_flag', 'true')
                location.href = 'setup.html'

            } else if (id == 'usermanage') {
                localStorage.setItem('check_flag', 'true')
                location.href = 'user-hrm.html'
            }
