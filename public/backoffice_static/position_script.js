...
async function getAPI_position() {
  try {
    ...
    let response = await fetch(
      ENDPOINT + "mobile/Get-Sequence-Position",
      {
        method: "POST",
        body: bodyContent,
        headers: headersList,
...
async function getAPI_rank() {
  try {
    ...
    let response = await fetch(
      ENDPOINT + "mobile/Get-Sequence-Rank",
      {
        method: "POST",
        body: bodyContent,
        headers: headersList,
...
async function btn_deleterow() {
  ...
  try {
    ...
    let response = await fetch(
      ENDPOINT + "mobile/Delete-position",
      {
        method: "POST",
        body: bodyContent,
        headers: headersList,
...
async function update_position(objData) {
  ...
  try {
    ...
    let response = await fetch(
      ENDPOINT + "mobile/Update-Position",
      {
        method: "POST",
        body: bodyContent,
        headers: headersList,
