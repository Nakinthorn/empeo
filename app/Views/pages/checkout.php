...
<body>
  ...
  <div class="modal hide" id='modal_success' style='display:flex;'>
    <div class="modal_content_check">
      ...
      <div class="modal_body">
        <div class="modal_msg">The check-out system is complete</div>
        <div class="gray fs-14px modal_text2" style="color: #6B6F80">Check out and take pictures.</div>
      </div>
      <div class="modal_footer_check">
  ...
  <script>
    ...
    sendButton.addEventListener('click', () => {
      ...
      navigator.geolocation.getCurrentPosition(function(position) {
        ...
        fetch(ENDPOINT + "mobile/checkOut", requestOptions)
          .then(response => response.json())
          .then(data => {
            if (data.code == 200) {
              model_success();
